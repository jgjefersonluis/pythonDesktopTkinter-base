...
label = Label(janela, width=20, height=2, text='Texto sera apresentado',
              relief='flat', fg='white', bg='#121211')
label.grid(row=0, column=0, padx=5, pady=10)

botao = Button(janela, command=executar, width=8, height=1,
               text='Clica aqui', relief='raised', fg='#fcb603', bg='gray')
